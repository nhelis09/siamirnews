...
<head>
    ...
    <title>Login - Forum Diskusi Siamir News</title>
    ...
    <center>
        <div class="container">
            <div class="login-container">
                ...
                <?php } ?>
                <?php } ?>
                <p>Yuk login terlebih dahulu untuk dapat mengakses forum diskusi bersama kawan anda disini</p>
                ...
                <p class="mt-3">Belum punya akun? <a href="registerakun.php">Daftar disini</a></p>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="laporanMasalahModalLabel">Perlu Bantuan? <br>Laporkan Masalah
                                Anda
                                Kepada Kami Sekarang</h5>
