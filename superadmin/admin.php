    ...
    <div class="container pt-0 shadow p-0 mb-0 bg-dark border">
        ...
        <div class="row p-3">
            ...
            <div class="col-md-8">
                ...
                <div class="col-md-8">
                    <form action="assets/cetakdataadmin.php" method="POST" target="_blank">
                        <input type="hidden" name="format" value="pdf">
                        <button type="submit" class="btn btn-primary mt-3">Cetak Data PDF</button>
                    </form>
                </div>
                <div class="col-md-8">
                    <form action="assets/cetakdataadmin.php" method="POST" target="_blank">
                        <input type="hidden" name="format" value="xls">
                        <button type="submit" class="btn btn-primary mt-3">Cetak Data Excel</button>
                    </form>
                </div>
